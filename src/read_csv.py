...
def add_previous_columns(drop_columns,periodicity_key, archive_name, test_size, historic_count,create_complete_csv):
    ...
    # order by date desc
    df = df.sort_values(by = const.DATE_COLUMN, ascending=0)
...
def create_scenario(interval, drop_columns, periodicity_key,
    ...
    drop_columns = drop_columns & utility_scenery_function.get_column_headers_def()
...
def create_scenarios(interval, periodicity_key,
                     test_size,historic_count, create_complete_csv):

    drop_columns_data = {
        '1_scenery': {'1_scenery','date', 'node', 'location', 'humidity', 'mq2', 'mq7', 'mq2_error', 'mq7_error',
                      'mq135_error'},

        '2_scenery': {'2_scenery','date','node','location','humidity','mq135','mq7','mq2_error', 'mq7_error',
                      'mq135_error'},

        '3_scenery': {'3_scenery', 'date', 'node', 'location', 'humidity', 'mq2', 'mq135', 'mq2_error', 'mq7_error',
                      'mq135_error'},
        # end
        '4_scenery': {'4_scenery', 'date', 'node', 'location', 'temperature', 'mq2', 'mq7', 'mq2_error', 'mq7_error',
                      'mq135_error'},
        '5_scenery': {'5_scenery', 'date', 'node', 'location', 'temperature', 'mq135', 'mq7', 'mq2_error', 'mq7_error',
                      'mq135_error'},
        '6_scenery': {'6_scenery', 'date', 'node', 'location', 'temperature', 'mq2', 'mq135', 'mq2_error', 'mq7_error',
                      'mq135_error'},
        # end
        '7_scenery': {'7_scenery', 'date', 'node', 'location',  'mq2', 'mq7', 'mq2_error', 'mq7_error',
                      'mq135_error'},
        '8_scenery': {'8_scenery', 'date', 'node', 'location',  'mq135', 'mq7', 'mq2_error', 'mq7_error',
                      'mq135_error'},
        '9_scenery': {'9_scenery', 'date', 'node', 'location',  'mq2', 'mq135', 'mq2_error', 'mq7_error',
                      'mq135_error'},
        # end
        '10_scenery': {'10_scenery', 'date', 'node', 'location', 'humidity', 'mq2', 'mq7', 'mq2_error', 'mq7_error'
                       },

        '11_scenery': {'11_scenery', 'date', 'node', 'location', 'humidity', 'mq135', 'mq7', 'mq7_error',
                       'mq135_error'},

        '12_scenery': {'12_scenery', 'date', 'node', 'location', 'humidity', 'mq2', 'mq135', 'mq2_error',
                       'mq135_error'},
        # end
        '13_scenery': {'13_scenery', 'date', 'node', 'location', 'temperature', 'mq2', 'mq7', 'mq2_error', 'mq7_error',
                      },
        '14_scenery': {'14_scenery', 'date', 'node', 'location', 'temperature', 'mq135', 'mq7', 'mq7_error',
                       'mq135_error'},
        '15_scenery': {'15_scenery', 'date', 'node', 'location', 'temperature', 'mq2', 'mq135', 'mq2_error',
                       'mq135_error'},
...
if __name__ == "__main__":
    create_scenarios('T', 'm', 0.3, 8, False)
